                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <button
                        ...
                        className="p-1.5 text-gray-400 hover:text-[#25D366] hover:bg-green-50 rounded transition-colors flex items-center gap-1"
                      ...
                      >
                        ...
                        {waSharedPosts.has(post.id) && (
                          <svg width="16" height="11" viewBox="0 0 20 14" fill="none" className="text-[#25D366]">
